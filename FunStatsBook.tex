...
Bethany Rognoni (Toowoomba, Australia)
\end{flushright}
...
Once you have watched the lecture recordings you should be able to answer the following \emph{Threshold} questions (solutions can be found at the end of this Workbook):
...
\subsection{Question 1: Generating an appropriate sample}\label{question-1-generating-an-appropriate-sample}
...
\item
  Using a random number generator (or below), select a simple random sample (SRS) from the sampling frame defined above.
\item
  How many males and females are there in your sample?
\item
  Using a random number generator (or below), select a second simple random sample.
\item
...
\item
  *Using a random number generator (or below), select a stratified random sample, stratified according to gender so as to contain equal numbers of males (m) and females (f).
\item
...
(Note: \url{https://stattrek.com/statistics/random-number-generator}.
...
\subsection{Question 2: Investigating the association between two categorical variables}\label{question-2-investigating-the-association-between-two-categorical-variables}
...
\caption{Coffee consumption and hours of sleep}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
7 hours or less per night
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\item
  how many students are light coffee drinkers?
\item
  how many students are heavy coffee drinkers AND sleep 7 or less hours per night?
\end{enumerate}
...
\item
  what percentage of students are light coffee drinkers?
\item
  what percentage of students are heavy coffee drinkers AND sleep 7 or
  less hours per night?
\item
  what percentage of students who are light coffee drinkers also sleep 7 or
  less hours per night?
\item
  what percentage of students who sleep 7 or less hours per night are light
  coffee drinkers?
\end{enumerate}
